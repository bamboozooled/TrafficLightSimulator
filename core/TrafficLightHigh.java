...
public class TrafficLightHigh{
    //------------------------
  // MEMBER VARIABLES
  //------------------------

  //TrafficLight State Machines
  public enum Status { AllRed, S_GLeft, N_Yellow, EW_Green, EW_Yellow, N_GLeft, S_Yellow, W_GLeft, }
